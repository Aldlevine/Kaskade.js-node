...
self.Bindings.if.init = function(element, context, value, property, type){
    ...
    bindingManager.ifElement = element.cloneNode(true);
    ...
    element.parentNode.replaceChild(bindingManager.ifElement, element);
    if(!value){
...
self.Bindings.unless.init = function(element, context, value, property, type){
    ...
    bindingManager.unlessElement = element.cloneNode(true);
    ...
    element.parentNode.replaceChild(bindingManager.unlessElement, element);
    if(value){
...
//ATTR
self.Bindings.attr = {};
self.Bindings.attr.init =
self.Bindings.attr.update = function(element, context, value, property, type){
    element.setAttribute(type, context[property]);
};
